================================================================================
    MICROSOFT 基础类库： NSPlayer 项目概述
===============================================================================

应用程序向导已为您创建了此 NSPlayer 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 NSPlayer 应用程序的每个文件的内容摘要。
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 NSPlayer.pch 的预编译头文件 (PCH)
